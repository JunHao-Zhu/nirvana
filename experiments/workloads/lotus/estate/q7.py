...
if __name__ == "__main__":
    logger = create_logger(log_dir="log/estate_lotus", log_name=f"q7_r{ROUND}")
    ...
    df = df.sem_map("Extract features from the {Details} about the estate.", suffix="Features")
    ...
    if ROUND == 1:
        df.to_csv("workloads/estate_output/q7_out_lotus.csv", index=False)
        logger.info(f"saved output to workloads/estate_output/q7_out_lotus.csv...")
