...
if __name__ == "__main__":
    logger = create_logger(log_dir="log/estate_lotus", log_name=f"q6_r{ROUND}")
    ...
    df = df.sem_filter("Observed from the house {image}, whether the house has a yard or not.", cascade_args=cascade_args)
    ...
    if ROUND == 1:
        df.to_csv("workloads/estate_output/q6_out_lotus.csv", index=False)
        logger.info(f"saved output to workloads/estate_output/q6_out_lotus.csv...")
