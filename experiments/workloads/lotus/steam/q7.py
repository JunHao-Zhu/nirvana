...
if __name__ == "__main__":
    logger = create_logger(log_dir="log/steam_lotus", log_name=f"q7_r{ROUND}")
    ...
    try:
        ...
        df = df.sem_filter("Is Chinese in the list of supported {languages}.", cascade_args=cascade_args)
    ...
    if ROUND == 1:
        df.to_csv("workloads/steam_output/q7_out_lotus.csv", index=False)
        logger.info(f"saved output to workloads/steam_output/q7_out_lotus.csv...")
