...
if __name__ == "__main__":
    logger = create_logger(log_dir="log/imdb_lotus", log_name=f"q10_r{ROUND}")
    ...
    if ROUND == 1:
        df.to_csv("workloads/imdb_output/q10_out_lotus.csv", index=False)
        logger.info(f"saved output to workloads/imdb_output/q10_out_lotus.csv...")
