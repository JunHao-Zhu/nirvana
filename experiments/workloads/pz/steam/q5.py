...
if __name__ == "__main__":
    logger = create_logger(log_dir="log/steam_pz", log_name=f"q5_r{ROUND}")
    ...
    df = df.sem_filter("The video game is about sports.", depends_on="genre")
    ...
    if ROUND == 1:
        output.to_df().to_csv("workloads/steam_output/q5_out_pz.csv", index=False)
        logger.info(f"saved output to workloads/steam_output/q5_out_pz.csv...")
