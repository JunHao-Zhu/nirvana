...
if __name__ == "__main__":
    logger = create_logger(log_dir="log/estate_pz", log_name=f"q2_r{ROUND}")
    ...
    new_column = [
        {"name": "Price", "type": str, "desc": "The estate price."}
    ]
    ...
    if ROUND == 1:
        output.to_df().to_csv("workloads/estate_output/q2_out_pz.csv", index=False)
        logger.info(f"saved output to workloads/estate_output/q2_out_pz.csv...")
