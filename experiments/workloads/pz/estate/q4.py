...
if __name__ == "__main__":
    logger = create_logger(log_dir="log/estate_pz", log_name=f"q4_r{ROUND}")
    ...
    logger.info(f"Q4: Extract the amentities from the estate details.")
    new_column = [
    ...
    if ROUND == 1:
        output.to_df().to_csv("workloads/estate_output/q4_out_pz.csv", index=False)
        logger.info(f"saved output to workloads/estate_output/q4_out_pz.csv...")
