...
if __name__ == "__main__":
    logger = create_logger(log_dir="log/estate_pz", log_name=f"q9_r{ROUND}")
    ...
    logger.info(f"Q9: Compute the average price of estates with more than 3 bedrooms and less than 6 bedrooms.")
    new_column = [
    ...
    if ROUND == 1:
        output.to_df().to_csv("workloads/estate_output/q9_out_pz.csv", index=False)
        logger.info(f"saved output to workloads/estate_output/q9_out_pz.csv...")
