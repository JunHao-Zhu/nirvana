...
if __name__ == "__main__":
    ...
    logger = create_logger(log_dir="log/estate", log_name=f"q2_r{ROUND}{ablation_suffix}")
    ...
    logger.info(f"Q2: Extract the house price from details.")
    ...
    if ROUND == 1:
        output.to_csv(f"workloads/estate_output/q2_out{ablation_suffix}.csv", index=False)
        logger.info(f"saved output to workloads/estate_output/q2_out{ablation_suffix}.csv...")
