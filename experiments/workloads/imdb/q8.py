...
if __name__ == "__main__":
    ...
    logger = create_logger(log_dir="log/imdb", log_name=f"q8_r{ROUND}{ablation_suffix}")
    ...
    df.semantic_filter(user_instruction="Whether the movie has won 2 Oscars.", input_columns=["Awards"])
    ...
    if ROUND == 1:
        output.to_csv(f"workloads/imdb_output/q8_out{ablation_suffix}.csv", index=False)
        logger.info(f"saved output to workloads/imdb_output/q8_out{ablation_suffix}.csv...")
